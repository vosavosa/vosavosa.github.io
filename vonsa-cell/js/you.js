 ...
 */
	...
	lazy_img : function(){
		...
		lazyNode.each(function(){
			var self = $(this);
			if(self.is('img')){
				self.attr('src','http://mat1.gtimg.com/news/2014/zt/mh17/you/images/loading.gif');
			}else{
				// 把原来的图片预先保存下来
				...
				self.css({
					'background-image'	: 'url(http://mat1.gtimg.com/news/2014/zt/mh17/you/images/loading.gif)',
...
/*  |xGv00|2335a847b793feecf66b7dc8340434ce */